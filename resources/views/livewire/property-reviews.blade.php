                    ...
                    <div class="card-body">
                        <div class="mb-2 d-flex align-center gap-2 flex-wrap">
                            <div class="avatar avatar-lg">
                                <img
                                    src="{{ $review->user->profile_photo_path ?? 'https://via.placeholder.com/100' }}"
                        ...
                        <form wire:submit.prevent="submitReview">
                            ...
                            <div class="modal-body">
                                @if($showSuccessMessage)
                                    <div class="alert alert-success">Thank you! Your review has been submitted for approval.</div>
                                @else
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="rating-selction">
                                            <input type="radio" wire:model="rating" value="5" id="rating5"><label for="rating5"><i class="fa-solid fa-star"></i></label>
                                            <input type="radio" wire:model="rating" value="4" id="rating4"><label for="rating4"><i class="fa-solid fa-star"></i></label>
                                            <input type="radio" wire:model="rating" value="3" id="rating3"><label for="rating3"><i class="fa-solid fa-star"></i></label>
                                            <input type="radio" wire:model="rating" value="2" id="rating2"><label for="rating2"><i class="fa-solid fa-star"></i></label>
                                            <input type="radio" wire:model="rating" value="1" id="rating1"><label for="rating1"><i class="fa-solid fa-star"></i></label>
                                        </div>
                                        @error('rating') <div class="text-danger mt-1">{{ $message }}</div> @enderror
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Review Title</label>
                                        <input type="text" wire:model.lazy="title" class="form-control" placeholder="e.g., A Wonderful Place">
                                        @error('title') <div class="text-danger mt-1">{{ $message }}</div> @enderror
                                    </div>
                                    <div class="mb-0">
                                        <label class="form-label">Write your review</label>
                                        <textarea wire:model.lazy="body" class="form-control" rows="4" placeholder="Share your experience..."></textarea>
