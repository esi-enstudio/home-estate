...
@section('title', 'Create New Listing | '. config('app.name'))
        ...
        <div class="breadcrumb-bar">
            ...
            <div class="row align-items-center text-center position-relative z-1">
                <div class="col-md-12 col-12 breadcrumb-arrow">
                    <h1 class="breadcrumb-title">নতুন লিস্টিং তৈরি করুন</h1>
                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">নতুন লিস্টিং</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 mx-auto">
                        <div class="cart-item-wrap">
                            {{-- Livewire ফর্ম কম্পোনেন্ট এখানে লোড হচ্ছে --}}
