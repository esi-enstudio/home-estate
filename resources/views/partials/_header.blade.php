                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="dropdown topbar-profile d-flex">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <!-- Item-->
                                            <a href="{{ route('listings.index') }}" class="dropdown-item d-inline-flex align-items-center">
                                                <i class="material-icons-outlined me-2">person_outline</i>আমার লিস্টিংসমূহ
                                            </a>
