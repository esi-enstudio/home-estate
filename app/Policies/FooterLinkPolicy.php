...
class FooterLinkPolicy
{
    ...
    {
        return $user->can('force_delete_footer::link');
    }
    ...
    {
        return $user->can('force_delete_any_footer::link');
    }
    ...
    {
        return $user->can('restore_footer::link');
    }
    ...
    {
        return $user->can('restore_any_footer::link');
    }
    ...
    {
        return $user->can('replicate_footer::link');
    }
    ...
    {
        return $user->can('reorder_footer::link');
    }
}
